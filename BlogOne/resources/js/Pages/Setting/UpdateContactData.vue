    ...
    <jet-form-section @submitted="updateContactInformation">
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-6" v-if="$page.props.jetstream.managesProfilePhotos">
                <AppImage :image-url="settings.data.contact_image_url" label="Photo" :error-message="form.errors.contact_image" v-model="form.contact_image"/>
            </div>
            ...
            <div class="col-span-6 sm:col-span-6">
                ...
                <AppTextarea id="google-map-url" type="text" class="mt-1 block w-full" v-model="form.google_map_url" autocomplete="google-map-url" />
